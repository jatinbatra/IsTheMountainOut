...
export default function SmsShareButton({ score, neighborhoodLabel }: Props) {
  ...
  return (
    <a
      href={href}
      className="group inline-flex items-center gap-2.5 px-5 py-2.5 rounded border border-gray-200 hover:border-gray-300 font-display text-sm text-[color:var(--type-2)] hover:text-[color:var(--type-1)] transition-all"
